...
- **기능**
  ...
  - 회원가입시 환영이메일 발송 기능
  - 고정 헤더에서 전체 음악 검색 기능
  - 플레이리스트 내 음악 재생, 일시정지, 반복,이전곡, 다음곡 기능
...
처음에 프로젝트를 시작하게되면서 협업에대해 어떻게 공동작업을하는지 뭐부터 시작해야 하는지 감이 하나도 안왔습니다. 그런데 주제를 정하고
역할을 나누고 피그마로 구상을하고 조원이 다같이 머리맞대고 깃허브 연습을 하면서부터 조금씩 협업에 틀이 만들어지더라구요. 그러다가 어느새보면
내가 작성한 코드와 조원이 작성한 코드 하나둘씩 합쳐지면서 프로젝트가 완성되어 가고있었습니다.
협업 프로젝트를 진행하는 동안에 충돌과 문제가 있었는데 하나둘씩 해결해가면서 또 잘안되는건 조원한테도 물어보면서 해결하고 그러다보니 처음에
협업 프로젝트에 대해 걱정했던 제가 오히려 협업해서 정말 다행이다라고 느끼게 됐습니다. 혼자 진행했던 초급 프로젝트때보다 협업하면서 진행한 중급 프로젝트가 몇 배는 더 많은걸 배우게되고 느낀 점도 많은거같습니다. 많이고생한 조원들 감사합니다!
...
프로젝트 준비~ 땅! 하자마자 바로 밤세며 했었는데 벌써 한달이 훌쩍 지나가 버려서 마감일 맞추듯 부랴부랴 프로젝트에만 몰두해 있었던 것 같습니다. (새벽에 배고파서 편의점 도시락 먹은 건 안비밀!)
프로젝트 초반에 깃허브 사용법을 조원들과 함께 테스트하고 연습하며 시작한 것이 서로 간 프로젝트 진행 상황을 확실하게 공유할 수 있었고 깃허브 사용하다 발생하는 오류에 대해 신속히 해결할 수 있었던 것 같습니다. 
(왜 merge가 아닌 리베이스를 하는지도 테스트하며 배웠고... 리베이스하다 잘못 수정하고 푸쉬하면 다음 메인에서 일부 코드가 사라져 있는 광경도 맨땅에 헤딩하며 알고.. 또..)
그리고 협업 작업을 통해 서로의 부족한 부분을 채워 가며 작업하니 든든했습니다.
주제 선정을 제가 하고 싶은 주제로 하게 되었고 제 작업이 늦게 마무리되어 미안했고 조원들이 제 부족한 부분을 채워준 것에 고맙습니다. (다들 너무 잘하셔서 ㅠㅠㅠㅠ)
모두 고생 많으셨고 다음 프로젝트에서도 다들 화이팅! 해요. 헤헿헿 

<br>

### ☎️ 최아정
로그인/회원가입 페이지가 가장 쉬운 부분이었단걸, 저 혼자 팀원분들과는 다른 출발점에서 시작한 것 같아서 늘 죄송한 마음이 있었습니다. 최대한 주어진 부분을 빨리 완수하고 다른 분들을 돕고 싶어 열심히 노력했습니다.
'git add .' 를 안해서 작업물을 날리기도하고, 제 능력의 한계를 느껴 답답했던 상황도 많았지만 팀원분들이 든든하게 옆에서 조언 해주셔서 잘 헤쳐나갈 수 있었습니다. 노력한 만큼 멋진 결과물로 보상받아 매우 뿌듯합니다.
다들 너무 수고 많으셨습니다! 짝짝짝 !
