...
### ☎️ 최아정
프로젝트 첫 시작부터 함께하지 못한 점과 로그인/회원가입 페이지가 가장 쉬운 부분이었다는 것을, 저 혼자 팀원분들과는 다른 출발점에서 시작한 것 같아서 늘 죄송한 마음이 있었습니다. 최대한 주어진 부분을 완수하고 다른 분들을 돕고 싶어 열심히 노력했습니다. 
프로젝트를 시작하기 전에는 제 실력을 누구보다 잘 알기에 걱정을 많이 했지만, 프로젝트를 진행하면서 깨달은 것은 제 머리가 생각이상으로 괜찮다는 점 입니다. 원래도 나쁘지 않다고 생각했지만, 이번 프로젝트를 통해 깨달았습니다. 
덕분에 다른 어떤 일을 맡더라도 겁 없이 도전할 수 있을 것 같습니다. 사실 방금까지 한 말은 50% 정도만 진심입니다. 
git add . 를 안해서 작업물을 날리기도하고, 제 능력의 한계를 느껴 답답했던 상황도 많았지만 팀원분들이 든든하게 옆에서 조언 해주셔서 잘 해쳐나갈 수 있었습니다. 다음 프로젝트때도 화이팅 해요! 
