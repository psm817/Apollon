...
### ☎️ 최아정
로그인/회원가입 페이지가 가장 쉬운 부분이었다는 것을, 저 혼자 팀원분들과는 다른 출발점에서 시작한 것 같아서 늘 죄송한 마음이 있었습니다. 최대한 주어진 부분을 완수하고 다른 분들을 돕고 싶어 열심히 노력했습니다. 
프로젝트를 시작하기 전에는 제 실력을 누구보다 잘 알기에 걱정을 많이 했지만, 작업을 진행하면서 깨달은 것은 제 머리가 생각이상으로 괜찮다는 점 이였습니다. 원래도 나쁘지 않다고 생각했지만, 이번 프로젝트를 통해 깨달았습니다. 
